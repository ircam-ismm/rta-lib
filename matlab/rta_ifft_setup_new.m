function [setup] = rta_ifft_setup_new (real_input, fft_size, scale)
%  function [setup] = rta_ifft_setup_new (real_input, fft_size, scale)
%
% Create a new setup for the fft algorithm from the RTA library.
%
% <fft_size> must be at least <real_input> size
% <scale> is optional and default value is 0. (scale by 1./fft_size)
%
% <setup> is a pointer the the newly created setup
%
% Use rta_ifft_setup_delete(setup) to release the memory of this setup
